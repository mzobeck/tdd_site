---
title: 'The Epistemic Arc - a conceptual map about how to learn from data in the presence
  of uncertainty '
author: Mark Zobeck
date: '2022-06-04'
slug: epistemic-arc-intro
categories:
...
summary: ''
authors: []
lastmod: '2022-06-04T17:12:00-05:00'
featured: no
projects: []
image: cover_expanded-epistemic_arc-wireframe.png
---
...
I recently [purchased and watched](https://hbiostat.regfox.com/rms2022-video-course) the videos for [Frank Harrell](https://twitter.com/f2harrell?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor)'s incredible statistics short course, [**Regression Modeling Strategies**](https://hbiostat.org/rms/)(for the more advanced stats enthusiasts, this course outlines an *incredible* method for principled statistical analyses). As part of the course, [Drew Levy](https://twitter.com/DrewLevy) gave a wonderful presentation about [model selection using causal models](https://hbiostat.org/doc/rms/causalModels.pdf), and, almost as an aside, he included a graphic about his framework for how he conceptualizes analyses of observational data.

I was struck by the elegance of his framework. It concisely summarizes the steps in the learning process and identifies the many danger zones that can ruin your learning ([click here to read more from Drew Levy's website](https://sites.google.com/dogoodscience.com/home)). It functions as a great conceptual roadmap for how to reliably learn from data while avoiding analytical shenanigans
...
![](cover_expanded-epistemic_arc-wireframe.png)
...
**Bonus:** [Directed acyclic graphs](https://www.jclinepi.com/action/showPdf?pii=S0895-4356%2821%2900240-7) ([DAGs](https://www.edx.org/course/causal-diagrams-draw-your-assumptions-before-your)) are a great way to graphically encode relevant information about the casual system, population, and sample from steps 1 and 2. I recommend their development in this step. DAGs can display not just confounding, but also [selection bias](https://pubmed.ncbi.nlm.nih.gov/15308962/) (and [here](https://pubmed.ncbi.nlm.nih.gov/28535177/)) and many other design considerations.

#### Step 3. Sample -> Data

![](step3-sample-data.png)
...
**Caution:** *Which* variables are measured matters both because of the potential for confounding as discussed in step 2, as well as the potential to induce *collider bias* that could emerge in step 5. *How* variables are measured also matters. For example, [continuous variables contain much more information than binary variables](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1458573/), so if the Learner chooses to classify a continuous variable as a binary variable (e.g. blood pressure as high or low instead of the systolic/diastolic measurements), then [the Learner loses information](https://www.fharrell.com/post/ordinal-info/) before any analysis has been performed.

**Beware:** More crippling problems arise here. [Measurement error](https://jech.bmj.com/content/58/8/635.long) refers to different ways of inaccurately collecting or recording data (e.g. measuring blood pressure in a screaming 3-year-old will not be accurate). [Information biases](https://jech.bmj.com/content/58/8/635.long) are a related and overlapping group of problems that occur during the conduct of the study that will make the analysis inaccurate. Incomplete or [missing data](https://www.youtube.com/watch?v=oMiSb8GKR0o) can ruin an otherwise well designed study. [Dichotomania](https://statmodeling.stat.columbia.edu/2019/09/13/deterministic-thinking-dichotomania/) (as discussed in the caution) can be so damaging that it prevent the Learner from answering his or her question when they would have been able to if the variables were measured as continuous or ordinal.

### Step 4. Data -> Analysis

![](step4-data-analysis.png)
...
**Beware:** Due to the technical nature of this step, many sneaky risks lurk here. Model assumptions, model specification, and model selection refer to the process of developing statistical models that reflect in math the most important concepts required to answer the question. The [bias-variance](https://www.youtube.com/watch?v=EuBBz3bI-aA&vl=en) trade off is an important decision about how flexible a model should be to reflect the observed data. P-hacking and [researchers degrees of freedom](https://www.americanscientist.org/article/the-statistical-crisis-in-science)/[garden of forking paths](http://www.stat.columbia.edu/~gelman/research/unpublished/p_hacking.pdf) are all non-mathematical methods of massaging the data (intentionally or unintentionally) to get an interesting or publishable result ([here is a blog post that discusses many of the preceding points](https://www.fharrell.com/post/improve-research/)). Also this is where you can *induce* bias by adding variables into your analysis, called [*collider bias*](https://jamanetwork.com/journals/jama/fullarticle/2790247#:~:text=Collider%20bias%20occurs%20when%20an,that%20is%20not%20controlled%20for.)([are you frightened?](https://getyarn.io/yarn-clip/ba49f8a3-0945-4a7b-b991-ca652b72a921/gif)). Analysis workflows (Bayesian workflows [here](https://arxiv.org/abs/2011.01808), and [here](https://www.nature.com/articles/s43586-020-00001-2.pdf), [RMS workflow](https://hbiostat.org/doc/rms.pdf) - chapter 4, particularly 4.12 - and [here](http://hbiostat.org/rflow/)) can help guide you safely through this treacherous valley of death and deceit.

### Step 6. Inference -> Decision

![](step6-inference-decision.png)
